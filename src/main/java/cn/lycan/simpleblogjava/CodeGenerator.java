package cn.lycan.simpleblogjava;
 ...
 * @author Makkapakka
 * @date 2022-6-28
 * @package_name cn.lycan.simpleblogjava
 * @description
 */
public class CodeGenerator {
     ...
     * 数据库连接配置
     */
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/simpleblog?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai";
     ...
     * 包名和模块名
     */
    private static final String PACKAGE_NAME = "cn.lycan";
    private static final String MODULE_NAME = "simpleblogjava";
    ...
    private static final String TABLE_PREFIX = "m_";
    ...
    public static void main(String[] args) {
        ...
        fastAutoGenerator.packageConfig(packageConfigBuilder -> packageConfigBuilder.parent(PACKAGE_NAME)
                ...
                .pathInfo(Collections.singletonMap(OutputFile.mapper, "src\\main\\resources\\mapper")));
